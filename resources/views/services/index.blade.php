        ...
        <div class="shell section-34 section-sm-50">
          <div class="range range-lg-middle">
            ...
            <div class="cell-lg-5 veil reveal-lg-block cell-lg-push-1 text-lg-left">
              <h2><span class="big">サービス</span></h2>
            </div>
          ...
          <div class="shell">
            ...
            <div class="range offset-top-66">
              <div class="cell-sm-8 cell-sm-preffix-2 cell-md-4 cell-md-preffix-0">
                        ...
                        <div>
                          <h4 class="text-bold offset-top-20">Consultancy</h4>
                          <p>
                            Intense looks perfect on any modern device, be it a laptop, a smartphone, or a tablet.<a href="/services/consultancy">>>もっと読む</a>
              ...
              <div class="cell-sm-8 cell-sm-preffix-2 cell-md-4 cell-md-preffix-0 offset-top-66 offset-md-top-0">
                        ...
                        <div>
                          <h4 class="text-bold offset-top-20">Designing</h4>
                          <p>
                            Intense is integrated with such popular social networks as Facebook, Twitter, Instagram and Flickr.<a href="/services/designing">>>もっと読む</a>
              ...
              <div class="cell-sm-8 cell-sm-preffix-2 cell-md-4 cell-md-preffix-0 offset-top-66 offset-md-top-0">
                        ...
                        <div>
                          <h4 class="text-bold offset-top-20">Training & Skills</h4>
                          <p>
                            Intense is a paradise for developers. Its initial release version comes shipped with 150+ responsive pages for any taste.<a href="/services/training_and_skills">>>もっと読む</a>
              ...
              <div class="cell-sm-8 cell-sm-preffix-2 cell-md-4 cell-md-preffix-0 offset-top-66 offset-md-top-0">
                        ...
                        <div>
                          <h4 class="text-bold offset-top-20">Maintainance</h4>
                          <p>
                            New child themes, skins and predesigned pages are being released 2-3 times per month. Intense owners get them for free.<a href="/services/maintainance">>>もっと読む</a>
